    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manager', models.ForeignKey(limit_choices_to={'role': 'MANAGER'}, on_delete=django.db.models.deletion.CASCADE, related_name='managed_products', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
